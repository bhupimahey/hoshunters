<?php
$header = array('title' => 'Change mobile');
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-11 col-xl-10 bg-gray">
					<div class="row"  id="changemobile">
					 <?php  $attributes = array('id' => 'changemobile_frm','name' => 'changemobile_frm','novalidate'=>'','class' => '','autocomplete' => 'off');
					        echo form_open('#', $attributes);							 
			         ?>
					<div class="full-row deshbord_panel w-100 mb-5">
							<h4 class="color-primary mb-4">Change Your Mobile</h4>
							
							<div class="submit_form color-secondery icon_primary p-5 bg-white">
							
									<div class="description">
									<?php $this->message_output->run(); ?>
										<h5 class="color-primary">Change your Australian mobile number</h5>
										<hr>
										...
										<button type="submit" class="btn btn-default1" id="changesmscodeSubmit">Send SMS Code</button>
													</div>
