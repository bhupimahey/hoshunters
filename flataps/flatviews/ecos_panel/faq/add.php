<?php
$header = array('title' => 'Add Faq Information');
				...
				<div class="col-md-11 col-xl-10 bg-gray">
					<div class="row">
						<div class="full-row deshbord_panel w-100 mb-5">
							<h4 class="color-primary mb-4">Add Faq Information Page</h4>
							...
							<div class="submit_form color-secondery icon_primary p-5 bg-white">
								<?php  $attributes = array('id' => 'faq_frm','name' => 'faq_frm','novalidate'=>'','class' => '','autocomplete' => 'off');
						                echo form_open_multipart(admin_path().'faq/add/submit', $attributes);							 
			                      ?>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'faq_title','required'=>'true',  'id'=> 'faq_title');
											...
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control ckeditor', 'name'=> 'faq_desc', 'id'=> 'faq_desc');
