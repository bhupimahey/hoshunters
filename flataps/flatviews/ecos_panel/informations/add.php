<?php
$header = array('title' => 'Add Information');
				...
				<div class="col-md-11 col-xl-10 bg-gray">
					<div class="row">
						<div class="full-row deshbord_panel w-100 mb-5">
							<h4 class="color-primary mb-4">Add Information Page</h4>
							...
							<div class="submit_form color-secondery icon_primary p-5 bg-white">
								<?php  $attributes = array('id' => 'information_frm','name' => 'information_frm','novalidate'=>'','class' => '','autocomplete' => 'off');
						                echo form_open_multipart(admin_path().'information/add/submit', $attributes);							 
			                      ?>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'information_name','required'=>'true',  'id'=> 'information_name');
											...
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control ckeditor', 'name'=> 'information_desc', 'id'=> 'information_desc');
											...
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'meta_title', 'id'=> 'meta_title');
														echo form_input($data); 
													?>
												</div>
											</div>
											...
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'meta_tag_desc', 'id'=> 'meta_tag_desc');
													echo form_input($data); 
													?>
												</div>
											</div>
											...
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'meta_tag_keywords','id'=> 'meta_tag_keywords');
													echo form_input($data); 
													?>
												</div>
											</div>
