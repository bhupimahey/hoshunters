<?php
$header = array('title' => 'Information List');
				...
				<div class="col-md-11 col-xl-10 bg-gray">
					<div class="row">
						...
						<div class="full-row deshbord_panel w-100 mb-5">
							<h4 class="color-primary mb-4">Information Pages List
							<div style="float:right;"><a href="<?php echo admin_path();?>information/add" class="btn btn-default1 appartment color-default ml-3"><i class="fa fa-plus"></i> Add</a></div>
							</h4>
