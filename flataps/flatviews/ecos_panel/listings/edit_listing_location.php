        ...
        <div class="row">
          <div class="full-row deshbord_panel w-100 mb-5">
            ...
            <?php  $attributes = array('id' => 'requestfrm2','name' => 'requestfrm2','role' => 'form','autocomplete' => 'off');
			     echo form_open(admin_path().'listings/update_locations/'.$profile_id.'/submit', $attributes);
                                        ...
                                        <td colspan="2"><label>Suburb</label><p>We recommend choosing at least 4 suburbs</p>
											...
											if($suburb){
											    foreach($suburb as $suburb_key => $suburb_val){
											        ...
											        echo '<div id="'.$suburb_key.'" class="row_address_new" ><input type="text" name="home_address[]" class="form-control seladdress" value="'.$suburb_val->location.'" placeholder="Address..."><button class="remove_new">X</button></div>';
											    }
...
<script type="text/javascript">
  ...
  $("#new").on("click", function() {
    ...
    var inc = $(".row_address").length + 1,
      $newAddressRow = '<div id="'+inc+'" class="row_address" ><input type="text" name="home_address[]" class="form-control" placeholder="Address..."><button class="remove">X</button></div>';
