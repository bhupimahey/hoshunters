			...
			<div class="row">
				...
				<div class="col-md-11 col-xl-10 bg-gray">
                	<div class="row">
		                                    ...
		                                    <div class="collapse show" id="collapseOne" role="tabpanel" style="">
		                                        <div class="card-body">
													...
													<div class="col-md-12">
													 ...
													 if($customer_photo_info && isset($customer_photo_info->photo))
                                            		      $customer_photo_path = '<img src="'.base_url().CNTPHT_THUMB.$customer_photo_info->photo.'" alt="#" />';
                                            		   else
                                            		     $customer_photo_path = '<img src="'.base_url().NO_IMAGE.'" alt="#" />';
                        ...
                        <br>
                        <div class="row">
                          <div class="col-md-12"> <a href="<?php echo admin_path();?>listings/edit_about_info/<?php echo $ListingInfo->profile_id;?>/1" class="btn btn-default1"> <span class="button-circle-span text-uppercase">Edit</span> </a> </div>
                        </div>
                                                    <br><br>
              ...
              <table class="w-100">
									...
									<tbody>
										<tr>
											...
											<td align="right">
												<a href="<?php echo admin_path();?>listings/locations/<?php echo $ListingInfo->profile_id;?>/2" class="btn btn-default1" data-id="2">Edit</a>
											</td>
              ...
              <table class="w-100">
									...
									<tbody> 
										<tr>
											...
											<td align="right">
												<a href="<?php echo admin_path();?>listings/edit_about_info/<?php echo $ListingInfo->profile_id;?>/1" class="btn btn-default1" data-id="5" >Edit</a>
											</td>
