				...
				<div class="col-md-11 col-xl-10 bg-gray">
					<div class="row">
						<div class="full-row deshbord_panel w-100 mb-5">
							<h4 class="color-primary mb-4">Add User</h4>
							...
							<div class="submit_form color-secondery icon_primary p-5 bg-white">
						        ...
						        echo form_open_multipart(admin_path().'users/add/submit', $attributes);							 
			                    ?>
									...
									<?php $this->message_output->run(); ?>
										...
										<div class="row">
											<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'full_name','required'=>'true',  'id'=> 'full_name','value'=>'');
										...
										<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'email_id','required'=>'true',  'id'=> 'email_id','value'=>'');
															echo form_input($data); 
													?>
												</div>
											</div>
									<div class="col-lg-12 col-md-12">
												<div class="form-group">
													<label>Password</label><span class="ml-2 fa-2x"></span>
													<?php $data = array('class' =>'form-control', 'name'=> 'password','required'=>'true',  'id'=> 'password','value'=>'');
															echo form_input($data); 
													?>
												</div>
											</div>		
										...
										<div class="col-lg-12 col-md-12">
												<div class="form-group">
													...
													<?php $data = array('class' =>'form-control', 'name'=> 'mobile_no','required'=>'true',  'id'=> 'mobile_no','value'=>'');
															echo form_input($data); 
													?>
												</div>
											</div>	
