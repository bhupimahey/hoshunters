    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12">
          <nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand pl-0" href="<?php echo base_url();?>"><!--<img class="nav-logo" src="<?php echo base_url();?>images/logo/logo1.jpg" alt="">--></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <?php } else{ ?>
              <div class="user_name color-primary-a float-lg-right p-3"> <a href="<?php echo base_url();?>login">Login</a> / <a href="<?php echo base_url();?>register">Register</a> </div>
              <?php } ?>
