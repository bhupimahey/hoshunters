...
<div class="full-row overflow-hidden">
	<div id="image-slider-2" style="width:1200px; height:800px; margin:0 auto;margin-bottom: 0px;">
		...
		<div class="ls-slide" data-ls="bgposition:50% 50%; duration:9000; transition2d:4; kenburnsscale:1.2;">
			<img width="1920" height="1080" src="<?php echo base_url();?>images/slider/02.jpg" class="ls-bg" alt="" />
			...
			<p style="font-weight:400; font-size:15px; line-height:76px; color:#ffffff; top:370px; left:53px; white-space:nowrap;" class="ls-l" data-ls="offsetyin:30; durationin:1000; delayin:600; offsetyout:-30; durationout:400; parallaxlevel:0;">Best featured family apartment this month</p>
			...
			<p style="font-weight:400; font-size:15px; line-height:76px; color:#ffffff; top:430px; left:53px; white-space:nowrap;" class="ls-l" data-ls="offsetyin:30; durationin:1000; delayin:1600; offsetyout:-30; durationout:400; parallaxlevel:0;"><i class="fa fa-map-marker color-default" aria-hidden="true"></i> 1744 Daylene Drive Newport MI 48166, Australia</p>
...
<div class="ls-slide" data-ls="bgposition:50% 50%; duration:9000; transition2d:4; kenburnsscale:1.2;">
			<img width="1920" height="1080" src="<?php echo base_url();?>images/slider/05.jpg" class="ls-bg" alt="" />
		...
		<!-- Slide 2-->
		<div class="ls-slide" data-ls="bgposition:50% 50%; duration:9000; transition2d:4; kenburnsscale:1.2;">
			<img width="1920" height="1080" src="<?php echo base_url();?>images/slider/04.jpg" class="ls-bg" alt="" />
		...
		<!-- Slide 3-->
		<div class="ls-slide" data-ls="bgposition:50% 50%; duration:9000; transition2d:4; kenburnsscale:1.2;">
			<img width="1920" height="1080" src="<?php echo base_url();?>images/slider/06.jpg" class="ls-bg" alt="" />
				  ...
				  <?php
				    ...
				    <div class="thumbnail_one mb_30 color-secondery">
						<div class="image_area overlay_one overfollow">
						   <a href="<?php echo base_url();?>F<?php echo random_string('numeric', 6);?><?php echo $list['listing_id'];?>"><?php echo $list['photo']; ?></a>						
					...
					<a href="<?php echo base_url();?>F<?php echo random_string('numeric', 6);?><?php echo $list['listing_id'];?>">	<?php echo $list['photo']; ?>	</a>				
						...
						<div class="thum_one_content"> 
							<div class="thum_title color-secondery">
								...
								<p><?php echo $room_furnishings;?> room in a <?php echo $room_type;?> <?php 
								if(isset($property_type[$list['property_type']]))
								echo $property_type[$list['property_type']];?> </p>
								<p><?php 
								if(strlen($list['about_yourself'])<50)  
								echo character_limiter($list['about_yourself'],20); 
								else{
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="box-two p_30 icon_default icon_font color-secondery rounded mb-4">
						...
						<p class="pt_15">Select your home or apartment and let’s contact with us. Ask what answer you need. You can also contact with the agent if you have any question.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="box-two p_30 icon_default icon_font color-secondery rounded mb-4">
		...
		<div class="row">
			<div class="col-mg-12 col-lg-12">
				<div class="alinment color-white">
					<h3 class="massage_one">How to Become Easy and Flexible to Living. Get A Comfortable apartment in Budget.</h3>
				</div>
			</div>
		</div>
	</div>
