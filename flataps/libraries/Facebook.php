...
require 'vendor/facebook/php-sdk-v4/src/Facebook/GraphObject.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/GraphSessionInfo.php';

require 'vendor/facebook/php-sdk-v4/src/Facebook/Entities/AccessToken.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookSession.php';

require 'vendor/facebook/php-sdk-v4/src/Facebook/HttpClients/FacebookHttpable.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/HttpClients/FacebookCurl.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/HttpClients/FacebookCurlHttpClient.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookSDKException.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookRequestException.php';
require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookAuthorizationException.php';

require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookResponse.php';

require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookRequest.php';

require 'vendor/facebook/php-sdk-v4/src/Facebook/FacebookRedirectLoginHelper.php';
